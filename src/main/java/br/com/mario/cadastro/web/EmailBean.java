...
public class EmailBean {
	...
	public void enviarEmail() {
		...
		AutenticaUsuario autenticaUsuario = new AutenticaUsuario(EmailBean.CONTA_GMAIL, EmailBean.SENHA_GMAIL); 
		...
		try {
			...
			envio.connect(EmailBean.SERVIDOR_SMTP, EmailBean.CONTA_GMAIL, EmailBean.SENHA_GMAIL);
			email.saveChanges(); 
	...
	public Properties configuracaoEmail() {
		...
		*/
		...
		config.put("mail.smtp.user", EmailBean.CONTA_GMAIL); // conta que esta enviando o email
